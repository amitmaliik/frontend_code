        ...
        >
          <div className="p-4 md:p-12 text-center lg:text-left">
            <div
              ...
              style={{
                backgroundImage: `url(${profileData?.instagram})`,
              }}
            ></div>
            ...
            <p className="pt-8 text-sm">I am a fucking bastard</p>
      ...
      <div className="navigation">
        <button onClick={() => handleLogout()}>
          <img
            ...
            src="https://www.dlf.pt/dfpng/middlepng/144-1447943_logout-icon-png-red-clipart-png-download-power.png"
            width="40px"
            alt="img"
          />
        </button>
                  ...
                  <div class="font-sans antialiased bg-grey-lightest">
                    ...
                    >
                      <div class="container mx-auto py-8">
                        <div class="w-3/4 lg:w-3/4 mx-auto bg-white rounded shadow">
                          <div class="py-4 px-4 text-black text-xl border-b border-grey-lighter">
                            Update Profile
                          </div>
                          <div class="py-4 px-8">
                            <div class="flex mb-4">
